...
if __name__ == '__main__':
    ...
    with tf.device(tf.DeviceSpec(device_type="GPU", device_index=0)):               
        #Error (line 63): Expecting a string device name. 
            # Got <class 'tensorflow.python.framework.device_spec.DeviceSpecV2'>(<tensorflow.python.framework.device_spec.DeviceSpecV2 object at 0x0000021C7474AF48>)
