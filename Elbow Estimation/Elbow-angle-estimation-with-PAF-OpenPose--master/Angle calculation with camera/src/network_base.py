...
import tf_slim as slim #tensorflow.contrib no longer exists, change to tf_slim 
...
_init_xavier = tf.initializers.GlorotUniform() #changed to tf.initializers.GlorotUniform()
_init_norm = tf.initializers.TruncatedNormal(stddev=0.01) #changed to tf.intializers.TruncatedNormal(stddev=0.01)
_init_zero = slim.init_ops.zeros_initializer()
_l2_regularizer_00004 = slim.l2_regularizer(0.00004) #changed to slim.l2_regularizer
_l2_regularizer_convb = slim.l2_regularizer(common.regularizer_conv) #changed to slim.l2_regularizer(common.regularizer_conv)
